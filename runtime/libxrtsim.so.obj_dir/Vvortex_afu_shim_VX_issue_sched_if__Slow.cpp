...
Vvortex_afu_shim_VX_issue_sched_if::Vvortex_afu_shim_VX_issue_sched_if(Vvortex_afu_shim__Syms* symsp, const char* v__name)
...
Vvortex_afu_shim_VX_issue_sched_if::~Vvortex_afu_shim_VX_issue_sched_if() {
}
