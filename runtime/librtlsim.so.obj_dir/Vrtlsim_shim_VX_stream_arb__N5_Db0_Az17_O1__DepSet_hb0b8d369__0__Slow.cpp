...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N5_Db0_Az17_O1___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__commit__DOT__g_commit_arbs__BRA__0__KET____DOT__commit_arb(Vrtlsim_shim_VX_stream_arb__N5_Db0_Az17_O1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N5_Db0_Az17_O1___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__commit__DOT__g_commit_arbs__BRA__0__KET____DOT__commit_arb\n"); );
    // Init
    VlWide<6>/*191:0*/ __Vtemp_2;
    // Body
    VL_RAND_RESET_W(176, __Vtemp_2);
    vlSelf->__Vxrand_h4f320efc__0[0U] = __Vtemp_2[0U];
    vlSelf->__Vxrand_h4f320efc__0[1U] = __Vtemp_2[1U];
    vlSelf->__Vxrand_h4f320efc__0[2U] = __Vtemp_2[2U];
    vlSelf->__Vxrand_h4f320efc__0[3U] = __Vtemp_2[3U];
    vlSelf->__Vxrand_h4f320efc__0[4U] = __Vtemp_2[4U];
    vlSelf->__Vxrand_h4f320efc__0[5U] = (0xffffU & 
                                         __Vtemp_2[5U]);
...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N5_Db0_Az17_O1___ctor_var_reset(Vrtlsim_shim_VX_stream_arb__N5_Db0_Az17_O1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N5_Db0_Az17_O1___ctor_var_reset\n"); );
    // Body
    VL_RAND_RESET_W(176, vlSelf->__Vxrand_h4f320efc__0);
    ...
    VL_RAND_RESET_W(180, vlSelf->g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb1__DOT__pipe_buffer__DOT____Vcellinp__g_register__DOT__g_pipe_regs__BRA__0__KET____DOT__pipe_register__data_in);
    VL_RAND_RESET_W(180, vlSelf->__PVT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb1__DOT__pipe_buffer__DOT__g_register__DOT__g_pipe_regs__BRA__0__KET____DOT__pipe_register__DOT__g_shift_register__DOT__g_shift__DOT__pipe);
}
