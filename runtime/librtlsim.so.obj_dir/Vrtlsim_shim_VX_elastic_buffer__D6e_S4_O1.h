...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_elastic_buffer__D6e_S4_O1 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_elastic_buffer__D6e_S4_O1(Vrtlsim_shim__Syms* symsp, const char* v__name);
