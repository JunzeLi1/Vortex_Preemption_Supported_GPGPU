...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_schedule_if final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_schedule_if(Vrtlsim_shim__Syms* symsp, const char* v__name);
