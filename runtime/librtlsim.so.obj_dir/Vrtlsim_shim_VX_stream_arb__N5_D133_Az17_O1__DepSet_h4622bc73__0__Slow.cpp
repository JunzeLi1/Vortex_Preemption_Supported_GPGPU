...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N5_D133_Az17_O1___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__commit__DOT__g_commit_arbs__BRA__0__KET____DOT__commit_arb(Vrtlsim_shim_VX_stream_arb__N5_D133_Az17_O1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N5_D133_Az17_O1___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__commit__DOT__g_commit_arbs__BRA__0__KET____DOT__commit_arb\n"); );
    // Init
    VlWide<10>/*319:0*/ __Vtemp_1;
    // Body
    VL_RAND_RESET_W(307, __Vtemp_1);
    vlSelf->__Vxrand_hfda20f8f__0[0U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[0U] 
                                         & __Vtemp_1[0U]);
    vlSelf->__Vxrand_hfda20f8f__0[1U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[1U] 
                                         & __Vtemp_1[1U]);
    vlSelf->__Vxrand_hfda20f8f__0[2U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[2U] 
                                         & __Vtemp_1[2U]);
    vlSelf->__Vxrand_hfda20f8f__0[3U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[3U] 
                                         & __Vtemp_1[3U]);
    vlSelf->__Vxrand_hfda20f8f__0[4U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[4U] 
                                         & __Vtemp_1[4U]);
    vlSelf->__Vxrand_hfda20f8f__0[5U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[5U] 
                                         & __Vtemp_1[5U]);
    vlSelf->__Vxrand_hfda20f8f__0[6U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[6U] 
                                         & __Vtemp_1[6U]);
    vlSelf->__Vxrand_hfda20f8f__0[7U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[7U] 
                                         & __Vtemp_1[7U]);
    vlSelf->__Vxrand_hfda20f8f__0[8U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[8U] 
                                         & __Vtemp_1[8U]);
    vlSelf->__Vxrand_hfda20f8f__0[9U] = (Vrtlsim_shim__ConstPool__CONST_h3c95891d_0[9U] 
                                         & __Vtemp_1[9U]);
...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N5_D133_Az17_O1___ctor_var_reset(Vrtlsim_shim_VX_stream_arb__N5_D133_Az17_O1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N5_D133_Az17_O1___ctor_var_reset\n"); );
    // Body
    VL_RAND_RESET_W(307, vlSelf->__Vxrand_hfda20f8f__0);
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->reset = VL_RAND_RESET_I(1);
    vlSelf->valid_in = VL_RAND_RESET_I(5);
    VL_RAND_RESET_W(1535, vlSelf->data_in);
    vlSelf->ready_in = VL_RAND_RESET_I(5);
    vlSelf->valid_out = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(307, vlSelf->data_out);
    ...
    VL_RAND_RESET_W(311, vlSelf->g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb1__DOT__pipe_buffer__DOT____Vcellinp__g_register__DOT__g_pipe_regs__BRA__0__KET____DOT__pipe_register__data_in);
    VL_RAND_RESET_W(311, vlSelf->__PVT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb1__DOT__pipe_buffer__DOT__g_register__DOT__g_pipe_regs__BRA__0__KET____DOT__pipe_register__DOT__g_shift_register__DOT__g_shift__DOT__pipe);
}
