...
#ifndef VERILATED_VRTLSIM_SHIM_VX_TCU_BHF_FMUL__PI81_H_
#define VERILATED_VRTLSIM_SHIM_VX_TCU_BHF_FMUL__PI81_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_tcu_bhf_fmul__pi81 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_tcu_bhf_fmul__pi81(Vrtlsim_shim__Syms* symsp, const char* v__name);
    ~Vrtlsim_shim_VX_tcu_bhf_fmul__pi81();
    VL_UNCOPYABLE(Vrtlsim_shim_VX_tcu_bhf_fmul__pi81);
