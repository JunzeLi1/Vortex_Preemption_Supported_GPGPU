...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__issue__DOT__g_slices__BRA__0__KET____DOT__issue_slice__DOT__scoreboard__DOT__out_arb(Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__issue__DOT__g_slices__BRA__0__KET____DOT__issue_slice__DOT__scoreboard__DOT__out_arb\n"); );
    // Init
    VlWide<4>/*127:0*/ __Vtemp_2;
    // Body
    VL_RAND_RESET_W(107, __Vtemp_2);
    vlSelf->__Vxrand_hc512475f__0[0U] = __Vtemp_2[0U];
    vlSelf->__Vxrand_hc512475f__0[1U] = __Vtemp_2[1U];
    vlSelf->__Vxrand_hc512475f__0[2U] = __Vtemp_2[2U];
    vlSelf->__Vxrand_hc512475f__0[3U] = (0x7ffU & __Vtemp_2[3U]);
...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3___stl_sequent__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__issue__DOT__g_slices__BRA__0__KET____DOT__issue_slice__DOT__scoreboard__DOT__out_arb__2(Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3___stl_sequent__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__issue__DOT__g_slices__BRA__0__KET____DOT__issue_slice__DOT__scoreboard__DOT__out_arb__2\n"); );
    // Body
...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3___ctor_var_reset(Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N8_D6b_Az208_O3___ctor_var_reset\n"); );
    // Body
    VL_RAND_RESET_W(107, vlSelf->__Vxrand_hc512475f__0);
