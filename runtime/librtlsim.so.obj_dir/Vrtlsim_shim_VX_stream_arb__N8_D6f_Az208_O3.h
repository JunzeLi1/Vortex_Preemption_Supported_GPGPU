...
#ifndef VERILATED_VRTLSIM_SHIM_VX_STREAM_ARB__N8_D6F_AZ208_O3_H_
#define VERILATED_VRTLSIM_SHIM_VX_STREAM_ARB__N8_D6F_AZ208_O3_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_stream_arb__N8_D6f_Az208_O3 final : public VerilatedModule {
  public:
    ...
    VL_INW(data_in,887,0,28);
    VL_OUTW(data_out,110,0,4);
    VlWide<4>/*113:0*/ __Vcellinp__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__data_in;
    VlWide<4>/*113:0*/ __PVT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb2__DOT__stream_buffer__DOT__g_buffer__DOT__data_out_r;
    VlWide<4>/*113:0*/ __PVT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb2__DOT__stream_buffer__DOT__g_buffer__DOT__buffer_r;
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_stream_arb__N8_D6f_Az208_O3(Vrtlsim_shim__Syms* symsp, const char* v__name);
    ~Vrtlsim_shim_VX_stream_arb__N8_D6f_Az208_O3();
    VL_UNCOPYABLE(Vrtlsim_shim_VX_stream_arb__N8_D6f_Az208_O3);
