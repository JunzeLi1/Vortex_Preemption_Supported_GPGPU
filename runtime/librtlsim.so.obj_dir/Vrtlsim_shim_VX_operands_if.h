...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_operands_if final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlWide<27>/*863:0*/ data;

    // INTERNAL VARIABLES
    Vrtlsim_shim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vrtlsim_shim_VX_operands_if(Vrtlsim_shim__Syms* symsp, const char* v__name);
