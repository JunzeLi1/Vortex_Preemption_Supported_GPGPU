...
#ifndef VERILATED_VRTLSIM_SHIM_VX_PE_SWITCH__PI45_H_
#define VERILATED_VRTLSIM_SHIM_VX_PE_SWITCH__PI45_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_pe_switch__pi45 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_pe_switch__pi45(Vrtlsim_shim__Syms* symsp, const char* v__name);
    ~Vrtlsim_shim_VX_pe_switch__pi45();
    VL_UNCOPYABLE(Vrtlsim_shim_VX_pe_switch__pi45);
